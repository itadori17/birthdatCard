...
export default function App() {
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.text}>Happy Hooray</Text><br/>
      <Text style={styles.text}>Birthdays are a new start, a fresh beginning and a time to pursue new endeavors with new goals.
